...
description: "Removing image backgrounds automatically using Photoshop."
...
![Small seed jar](SmallSeedJar.jpg){width=350}
...
![New action](NewAction.png){width=350}
...
![Select subject](SelectSubject.png){width=350}
...
![Select subject results](SelectSubjectResults.png){width=350}
...
![Black and white mask](BlackandWhiteMask.png){width=200}
...
![Delete open step](DeleteOpenStep.png){width=350}
...
![Batch process](BatchProcess.png){width=350}
...
![Mask results](MasksResults.png){width=350}
