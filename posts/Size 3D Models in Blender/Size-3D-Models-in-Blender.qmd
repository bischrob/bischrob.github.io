...
description: "How to accurately size 3D models using Blender."
...
![Size 3D Models in Blender](Measuring.png)
...
![Reside 3D Models in Blender](DeleteCube.png)
...
![Resize 3D Models in Blender](ImportCropped.png)
...
![Imported object](Importedobject.png)
...
![Origin to Geometry](Origin2Geometry.png)
...
![Change Scene Units](ChangeSceneUnitscropped.png)
...
Thanks for reading the tutorial and feel free to comment below or [email me](mailto:bischrob@gmail.com) if you have any questions, or if you have any suggestions on improving this process.
